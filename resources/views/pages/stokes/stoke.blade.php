...
@section('content')
     <div class="flex-row">
        ...
        <a href="{{url('/pharmacy/Creport/stock-report-supplier-wise')}}" class="btn btn-info pull-right waves-effect waves-light">
            <span class="fa fa-list add_brand"> Stoke Report(Supplier Wise)</span></a>
