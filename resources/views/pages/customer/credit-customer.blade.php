...
@section('content')
     <div class="flex-row">
        ...
        <a href="{{url('/pharmacy/Ccustomer/customer')}}" class="btn btn-info pull-right waves-effect waves-light">
            ...
            <span class="fa fa-plus-circle add_brand"> Paid Customer</span></a>
                                   ...
                                   <thead class="thead-default">
                                    ...
                                    @for($i=0; $i<6; $i++)        
                                         <tr>
                                            ...
                                            <td>01</td>
                                            <td>
                                                <img width="60" height="60" src="https://pencil.spantiklab.com/uploads/customers/default.jpg" alt="User Image">
                                            </td>
                                            <td>Amirul</td>
                                            <td>0174063****</td>
                                            <td>Rajshahi</td>
